...
const InstagramBusinessAccountItem: React.FC<{ igBusinessAccount: IGBusinessAccount}> = ({ igBusinessAccount }: {igBusinessAccount: IGBusinessAccount}) => {
    ...
    return (
        <div className="instagramBusinessAccount">
            <img className="igBusinessAccount_profile_picture_url" src={igBusinessAccount.profile_picture_url} alt=""/>
            ...
            <div className="pageDescriptionWrapper">
                ...
                <p className="igBusinessAccount_username">{igBusinessAccount.username}</p>
            </div>
            <div className="pageDescriptionWrapper">
                <p className="descriptionLeadText">{biography}</p>
                <p className="igBusinessAccount_biography">{igBusinessAccount.biography}</p>
            </div>
            <div className="pageDescriptionWrapper">
                <p className="descriptionLeadText">{followers_count}</p>
                <p className="igBusinessAccount_followers_count">{igBusinessAccount.followers_count}</p>
            </div>
            <div className="pageDescriptionWrapper">
                <p className="descriptionLeadText">{follows_count}</p>
                <p className="igBusinessAccount_follows_count">{igBusinessAccount.follows_count}</p>
            </div>
            <div className="pageDescriptionWrapper">
                <p className="descriptionLeadText">{media_count}</p>
                <p className="igBusinessAccount_media_count">{igBusinessAccount.media_count}</p>
            </div>
            <div className="pageDescriptionWrapper">
